    ...
    >
      ...
      <CharacterSheetDialogContent>
        ...
        <section className={styles.section}>
          ...
          <p>
            DBから読み込んだキャラクターの変更内容はブラウザへ自動保存されません。変更を残したい場合は「
            <strong>DB保存</strong>」を行ってください。
          </p>
          <p>
        ...
        <section className={styles.section}>
          ...
          <p>
            DBから読み込んだキャラクターに未保存の変更がある状態で別のキャラクターへ切り替えた場合、その変更内容は破棄されます。必要な変更は、切り替える前に「
            <strong>DB保存</strong>」してください。
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            DBから読み込んだキャラクターの変更内容は自動保存されません。ページの再読み込みや別のキャラクターへの切り替えを行う前に、変更を残したい場合は「
            <strong>DB保存</strong>」してください。
          </p>
          <p>
