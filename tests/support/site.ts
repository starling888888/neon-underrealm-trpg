...
const localBaseUrl = `${visualBaseHost}:${visualBasePort}${normalizedVisualBasePath}`;
export const visualBaseUrl = localBaseUrl;
export const siteBaseUrl =
  process.env.E2E_BASE_URL ?? "http://127.0.0.1:4322/neon-underrealm-trpg/";
