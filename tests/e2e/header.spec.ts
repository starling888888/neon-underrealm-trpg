...
test("header stays above the tablet sticky page heading @header-scroll-behavior @local-fixture", async ({
  page,
}) => {
...
test("header stays fixed at the 768px tablet boundary @header-scroll-behavior @local-fixture", async ({
  page,
}) => {
