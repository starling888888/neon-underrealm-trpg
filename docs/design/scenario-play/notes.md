...
- states:
  - hero画像、シーン進行、情報収集の例、縁、小銭、戦闘準備、終了後処理を含む通常表示
...
- typography direction: シーン進行、各シーンの役割、情報収集、縁、小銭、戦闘準備、終了後処理の見出し階層を保つ。情報収集の例は本文と区別されたCalloutで示す。
...
- 小銭の算出、非戦闘判定後の消費、戦闘準備での範囲が段階的に読める。
...
- source branch / commit when applicable: `24-2-scenario-play-page` / `5148cc0`
- route: `/rules/scenario-play/`
- viewport:
