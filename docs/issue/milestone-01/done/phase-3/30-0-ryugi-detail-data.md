...
変換仕様の正本ファイル名は `ryugi-skills.md` とする。`docs/issue/milestone-01/plan.md` のタスク名・参照と
...
- `docs/issue/milestone-01/plan.md` の `30-0-ryugi-detail-data`
...
- `docs/requirements/architecture.md`、`docs/issue/milestone-01/plan.md`、関連参照で、流儀スキル変換仕様の
...
- [x] `docs/requirements/architecture.md`、`docs/issue/milestone-01/plan.md`、関連参照で、流儀スキル変換仕様の
