...
`docs/issue/milestone-01/plan.md` の `31-0-ikizama-index-data` は、一覧ページ用の変換仕様、検証、変換処理、取得層、テストを先行して整備するタスクである。静的サイトのCI/CD buildはExcel本体に依存せず、Git管理する生成JSONを読み込む必要がある。
...
- `docs/issue/milestone-01/plan.md` の `31-0-ikizama-index-data`
