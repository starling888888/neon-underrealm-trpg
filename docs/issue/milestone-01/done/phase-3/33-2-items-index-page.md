...
- `docs/issue/milestone-01/plan.md` の `33-2-items-index-page` は、アイテムトップページの作成を計画している。
...
- `docs/issue/milestone-01/plan.md`と`docs/requirements/pages.md`を、contentsの正本に追従させる。
...
- source: local-pr-review
- classification: valid
- local validation: ユーザーはレビュー指摘1に対し、「1件以上は表示、0件は『見出しがありません』」と方針を明示し、実装を承認した。`docs/requirements/layout-navigation.md`、`docs/issue/milestone-01/plan.md`、実装・テストは新方針に一致する一方、`docs/issue/33-2-items-index-page.md`と`docs/design/items/notes.md`の旧記述が矛盾する。
