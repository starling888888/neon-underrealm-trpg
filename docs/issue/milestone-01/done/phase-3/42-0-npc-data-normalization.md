...
`21-2-world-page`では、NPC紹介を世界観本文内の静的`NpcCard`として実装した。`docs/issue/milestone-01/plan.md`の`42-0-npc-data-normalization`と関連TODOでは、個別画像、Excel / JSON管理、`/world`の生成JSON参照への移行を後続タスクとしている。
...
- `docs/issue/milestone-01/plan.md`の`42-0-npc-data-normalization`
