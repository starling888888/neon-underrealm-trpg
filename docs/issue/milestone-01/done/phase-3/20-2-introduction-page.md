...
`docs/issue/milestone-01/plan.md` の `20-2-introduction-page` を実施する。トップページにはすでにゲーム概要と `/introduction` への導線があり、SiteMenuにも「はじめに」が定義されている。一方で、対象ページ本体は未作成である。
...
- `docs/requirements/pages.md`、`docs/issue/milestone-01/plan.md`、`docs/TODO.md` の責務整理は、issue作成前にユーザーが明示した指示を反映済みである。変更記録は `.tmp/review/20-2-introduction-page/user-directed-changes.md` にある。
