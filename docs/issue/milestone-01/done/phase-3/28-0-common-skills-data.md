...
`docs/issue/milestone-01/plan.md` の `28-0-common-skills-data` は、後続の `28-1-common-skills-components` と `28-2-common-skills-page` が共通スキルを表示するためのデータ基盤を先に用意するタスクである。
...
- `docs/issue/milestone-01/plan.md` の `28-0-common-skills-data`
