...
`docs/issue/milestone-01/plan.md` の`34-1-item-card-components`は、武器、防具、お守り、サイバネ、ナノマシン、ドラッグを個別Card Componentとして整備し、`SkillCard`を含めたカードデザインと凡例用Propsを統一するタスクである。
...
- `docs/issue/milestone-01/plan.md` の`34-1-item-card-components`
