...
`docs/issue/milestone-01/plan.md` の `21-2-world-page` は、初期公開範囲のワールドガイドを作成するタスクである。ローカル作業入力 `.raw/contents/world.md` は作成済みであり、現行のユーザー指示を反映して、常体の世界観本文、強大な敵4種、NPC紹介、hero画像生成プロンプトを含む。
