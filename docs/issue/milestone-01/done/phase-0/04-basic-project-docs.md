...
`docs/issue/milestone-01/plan.md` の Phase 0 にある基本ドキュメント整備タスクとして、以後の開発者や生成AIエージェントが共通の手順を参照できるようにする必要がある。
...
- [x] `README.md` にプロジェクト概要が書かれている
- [x] `README.md` に主要コマンドが書かれている
- [x] `README.md` に主要ドキュメントへの導線がある
- [x] `docs/deployment.md` に初期公開方針と将来のGitHub Pages公開手順の枠が書かれている
- [x] `docs/content-writing-guide.md` にMarkdown / MDX本文管理の初期方針が書かれている
- [x] 初期開発・ビルド手順が記載されている
- [x] `npm run check` が通る
- [x] `npm run build` が通る
