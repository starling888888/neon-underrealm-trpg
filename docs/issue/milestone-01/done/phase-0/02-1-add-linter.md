...
このタスクは `docs/issue/milestone-01/plan.md` にはない補助タスクとして扱う。
...
- `docs/issue/milestone-01/done/phase-0/02-init-astro-project.md`
...
- `docs/issue/milestone-01/done/phase-0/02-1-add-linter.md`
...
作業開始時点で、`docs/issue/milestone-01/plan.md` に `02-init-astro-project` の完了チェックを入れる未コミット変更が存在している。この変更は本タスクでは編集しない。
