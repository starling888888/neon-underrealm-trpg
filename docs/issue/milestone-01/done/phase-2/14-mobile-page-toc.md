...
`docs/issue/milestone-01/plan.md` の `14-mobile-page-toc` は、Phase 2 の「スマホ用ページ内目次を実装する」タスクである。
...
- local issue file: `docs/issue/milestone-01/done/phase-2/14-mobile-page-toc.md`
- `docs/issue/milestone-01/plan.md` に `14-mobile-page-toc` が存在する
...
- local validation:
  ...
  - `docs/issue/milestone-01/done/phase-2/14-mobile-page-toc.md` は本文内H1横trigger案へ更新済みのため、design notes側を現行実装方針へ追従させるのが最小対応である。
