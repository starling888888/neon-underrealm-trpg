...
- 必要に応じて `docs/issue/milestone-01/done/phase-2/15-1-menu-expand-current-ancestors-only.md`
...
- issue file: `docs/issue/milestone-01/done/phase-2/15-1-menu-expand-current-ancestors-only.md`
- plan task: `docs/issue/milestone-01/plan.md` に `15-1-menu-expand-current-ancestors-only` を未完了タスクとして追加する
