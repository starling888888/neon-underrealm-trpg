...
- この追加仕様は、ユーザー承認済みの追加仕様として `docs/requirements.md` と `docs/issue/milestone-01/plan.md` に反映する

## 背景

`docs/issue/milestone-01/plan.md` の `13-page-toc` は、Phase 2 の「PC右ページ内目次を実装する」タスクである。
...
- この追加仕様を `docs/requirements.md` と `docs/issue/milestone-01/plan.md` に反映する
...
- `docs/issue/milestone-01/plan.md` への追加仕様反映
...
- [x] `docs/issue/milestone-01/plan.md` にユーザー承認済み追加仕様が反映されている
...
## `docs/issue/milestone-01/plan.md` 反映方針
...
今回の追加仕様により、`docs/requirements.md` と `docs/issue/milestone-01/plan.md` の更新は対象範囲に含める。
...
- local issue file: `docs/issue/milestone-01/done/phase-2/13-page-toc.md`
- `docs/issue/milestone-01/plan.md` に `13-page-toc` が存在する
...
- このIssueで `docs/requirements.md` と `docs/issue/milestone-01/plan.md` に追加仕様を反映してよいか、人間レビューで確認する
