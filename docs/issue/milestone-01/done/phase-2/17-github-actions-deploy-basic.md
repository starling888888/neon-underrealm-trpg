...
`docs/issue/milestone-01/plan.md` 上の `17-github-actions-deploy-basic` を実施する。
...
main以外のbranch / PRで通常CIを回す恒久整備は、このIssueでは実装しない。代わりに、`docs/TODO.md` と `docs/issue/milestone-01/plan.md` に後続タスクとして追記する。
...
- `docs/issue/milestone-01/plan.md` の最終フェーズ末尾への、main以外でもdeployなしCIを回すためのテスト / CI整備タスク追加
...
- [x] `docs/issue/milestone-01/plan.md` の最終フェーズ末尾に、main以外でもdeployなしCIを回すためのテスト / CI整備タスクが追加されている
- [x] `npm run build` が通る
- [x] `npm run check` が通る
...
- `docs/TODO.md` と `docs/issue/milestone-01/plan.md` に追加する後続CI整備項目の粒度が適切か
...
- [ ] main以外のbranch / PRでdeployなしCIを回せるようにする
  ...
  - plan: `docs/issue/milestone-01/plan.md` の `54-ci-non-main-branches`
...
`docs/issue/milestone-01/plan.md` の最終フェーズ末尾に以下を追加する。
...
test -f docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md && echo "issue exists"
...
- issue file: `docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md`
- `docs/issue/milestone-01/plan.md` に `17-github-actions-deploy-basic` が存在する
...
main以外のbranch / PRで通常CIを回す恒久整備は、このIssueでは実装しない。`docs/TODO.md` と `docs/issue/milestone-01/plan.md` に後続タスクとして追跡する。
...
- `docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md` の完了条件とチェックポイントで、ローカル検証済み項目、初回deploy確認済み項目、merge後にしか確認できない項目が同じ `[x]` として混在している。
...
- [x] `docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md` の完了条件を、検証種別ごとに誤解なく読める形へ整理する
