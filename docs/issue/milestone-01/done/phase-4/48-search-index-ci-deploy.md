...
- `docs/issue/milestone-01/plan.md` の `48-search-index-ci-deploy`
- `docs/issue/milestone-01/done/phase-4/43-install-pagefind.md`
...
- [x] GitHub Pagesの公開環境で検索UIがPagefind indexを参照し、検索結果を表示できる。
...
- GitHub Pages上の実検索は、マージ後のユーザー動作確認済みである。
