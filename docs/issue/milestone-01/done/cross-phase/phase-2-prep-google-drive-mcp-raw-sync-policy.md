...
このissueは、`docs/issue/milestone-01/plan.md` の通常タスク番号体系には入れない。
...
- `docs/issue/milestone-01/plan.md` へのタスク追加をしない
- `docs/issue/milestone-01/plan.md` の完了チェック状態を変更しない
- `.raw/**` をGit管理しない
...
- [x] `docs/issue/milestone-01/plan.md` へタスク追加していない
...
- Drive書き込み操作が禁止されている
- `docs/issue/milestone-01/plan.md` には入れない
...
- TODO routing: なし。いずれもこのissueの範囲内で修正可能であり、`docs/TODO.md` や `docs/issue/milestone-01/plan.md` へ送らない。
