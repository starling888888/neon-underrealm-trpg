...
このtaskは `docs/issue/milestone-01/plan.md` 外の、ユーザーの明示指示による独立taskとして扱う。`docs/TODO.md` に直接対応する項目はない。
...
- reviewer指摘を未検証のままcurrent issue、`docs/TODO.md`、`docs/issue/milestone-01/plan.md`、`docs/agent-failure-log.md`へ反映しない。
...
- [x] reviewerの要件・判断基準が`AGENTS.md`、current issue、`docs/requirements.md`、`docs/out-of-scope.md`、`docs/issue/milestone-01/plan.md`、`docs/TODO.md`の優先順位と矛盾していない。
