...
- `docs/issue/milestone-01/plan.md` の特別task命名規約に従う。
- `AGENTS.md`、`.agents/skills/README.md`、contents関連skill / rule、`.agents/rules/mcp.md`、`.agents/rules/data-management.md`、`.agents/rules/file-structure.md`、`docs/issue/milestone-01/plan.md`、`docs/requirements/architecture.md`、`docs/content-writing-guide.md`、`docs/development-structure.md`、`README.md`は、現行で削除対象workflowまたは`.raw/contents/`の優先正本を参照している。実装時に、手動contents運用とSpreadsheet専用同期へ整合させる。
...
- [x] `drive-to-raw-sync`と`raw-to-drive-sync`のskill本体を削除し、参照元の`AGENTS.md`、`.agents/rules/mcp.md`、`.agents/rules/data-management.md`、`docs/issue/milestone-01/plan.md`、`README.md`を、手動contents運用とSpreadsheet専用同期へ整合させる。
