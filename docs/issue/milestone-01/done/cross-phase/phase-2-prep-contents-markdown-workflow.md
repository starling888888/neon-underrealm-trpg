...
- PRは作成しない
- commit / pushは行わない
- `docs/issue/milestone-01/plan.md` のチェックボックスを完了扱いにしない
- `docs/issue/milestone-01/plan.md` への退避を行わない
...
- [x] `docs/issue/milestone-01/plan.md` に `.raw/contents/*.md` の古い前提が残っている場合、新方針に合わせて修正されている
...
- plan handling: user explicitly approved `plan追加不要`; this issue may update existing `docs/issue/milestone-01/plan.md` wording but must not add a new plan item or mark plan checkboxes complete
