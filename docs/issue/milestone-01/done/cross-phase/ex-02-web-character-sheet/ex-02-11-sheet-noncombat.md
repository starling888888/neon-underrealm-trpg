...
- Gate plan: `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/plan.md` の `G11`
...
- canonical VRT baselineを作成・更新しない。`docs/issue/milestone-01/plan.md` のチェックボックスを変更しない。
