...
- Gate plan: `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/plan.md`のG15
...
| 対象              | 判定     | 差分                                                                                                  | 対応                                                                                                                          |
| ----------------- | -------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `character-sheet` | 確認済み | 新設した5状態・15 viewportはlocator-onlyとしてcapture時だけ実行し、通常VRTのfull-page比較へ参加しない | locator screenshotを実際に開き、各状態の領域、候補dialog、error枠、削除確認の表示を確認した。canonical baselineは更新しない。 |
