...
- 依存Gate: G0（`docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-0-sheet-page-header.md`）、G1（`docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-1-sheet-runtime.md`）
...
- `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/plan.md`（G2完了後の耐久的な引継ぎ）
