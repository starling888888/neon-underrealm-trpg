...
- local validation: `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/plan.md`のG19 / G20引継ぎ、G31の範囲、G21のVisual Review 1、`tests/visual/vrt/character-sheet.spec.ts`を照合した。local canonical snapshotの更新自体はユーザー承認済みであり、Git管理への追加・変更は行っていない。
