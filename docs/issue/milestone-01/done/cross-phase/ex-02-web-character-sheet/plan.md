...
- Gate完了時は、子issueの確定事項をdesign notes、architecture、requirementsへそれぞれの正本として差し戻し、後続Gateに必要な前提だけをこのplanへ記録する。完了条件、チェックポイント、レビュー記録は子issueに保持し、親planやほかの正本へ差し戻さない。その後、子issueを`docs/issue/milestone-01/done/`へ移す。
...
| ---- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| G0   | done | なし                                                                                                                                            | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-0-sheet-page-header.md`                | Astro pageとページ固有のサイトメニュー表示を作成する。HeaderとFooterは再設計しない。                                                                                                                                                                 |
| G1   | done | G0                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-1-sheet-runtime.md`                    | React Islandなどの実行基盤を整備する。                                                                                                                                                                                                               |
| G2   | done | G0, G1                                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-2-sheet-layout.md`                     | desktopでは`80rem`以上で等分2列、tablet/mobileでは一列の基本レイアウトを提供する。                                                                                                                                                                   |
| G3   | done | G2                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-3-sheet-section-frame.md`              | 編集セクションの共通枠と開閉操作を作成する。                                                                                                                                                                                                         |
| G4   | done | G1, G2, G3                                                                                                                                      | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-4-sheet-profile.md`                    | 基本情報、キャラクター設定、信用を扱う。                                                                                                                                                                                                             |
| G5   | done | G1, G2, G3                                                                                                                                      | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-5-sheet-dialogs.md`                    | ダイアログの共通基盤を整備する。                                                                                                                                                                                                                     |
| G6   | done | G4, G5                                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-6-sheet-image.md`                      | 承認済みdraftのprofile / setting / image / credit配置を保ち、キャラクター画像を扱う。                                                                                                                                                                |
| G7   | done | G1, G2, G3                                                                                                                                      | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-7-sheet-build.md`                      | 流儀、生き様、能力値、経験点を扱う。                                                                                                                                                                                                                 |
| G8   | done | G7                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-8-sheet-secondary.md`                  | 副能力値を扱う。                                                                                                                                                                                                                                     |
| G9   | done | G7, G8                                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-9-sheet-bonds.md`                      | 縁と覚悟を扱う。                                                                                                                                                                                                                                     |
| G10  | done | G7                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-10-sheet-attack-reaction.md`           | 攻撃とリアクションを扱う。                                                                                                                                                                                                                           |
| G11  | done | G7                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-11-sheet-noncombat.md`                 | 非戦闘技能を扱う。                                                                                                                                                                                                                                   |
| G12  | done | G7                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-12-sheet-primary-skills.md`            | プライマリ流儀のスキルを扱う。                                                                                                                                                                                                                       |
| G13  | done | G7                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-13-sheet-ikizama-skills.md`            | 生き様のスキルを扱う。                                                                                                                                                                                                                               |
| G14  | done | G7, G12                                                                                                                                         | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-14-sheet-common-skills.md`             | 共通スキルを扱う。                                                                                                                                                                                                                                   |
| G15  | done | G7, G12                                                                                                                                         | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-15-sheet-other-ryugi-skills.md`        | その他流儀のスキルを扱う。                                                                                                                                                                                                                           |
| G16  | done | G7, G12, G13, G14, G15                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-16-sheet-experience-consistency.md`    | 消費経験点の算出整合性を確認する。                                                                                                                                                                                                                   |
| G17  | done | G4, G7                                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-17-sheet-weapons-armor.md`             | 武器と防具を扱う。                                                                                                                                                                                                                                   |
| G18  | done | G4                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-18-sheet-omamori.md`                   | お守りの個別行の選択・追加・削除・並べ替え・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                               |
| G19  | done | G4                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-19-sheet-cybernetics.md`               | サイバネの個別行の選択・行操作・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                                           |
| G20  | done | G4                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-20-sheet-nanomachines.md`              | ナノマシンの固定個別行の選択・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                                             |
| G21  | done | G4                                                                                                                                              | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-21-sheet-drugs.md`                     | ドラッグの個別行の選択・追加・削除・並べ替え・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                             |
| G22  | done | G4, G7, G17, G18, G19, G20, G21                                                                                                                 | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-22-sheet-special-items-integration.md` | 消費信用を一元算出し、生き様別の既定カテゴリ表示、未選択時のカテゴリ非表示、カテゴリ単位の追加・削除、生き様変更時の入れ替え、通常選択不可の保持アイテム警告、および選択中ナノマシンの発動精神力最大値を最大体力へ反映する生き様との接続を実装する。 |
| G23  | done | G2, G3, G5                                                                                                                                      | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-23-sheet-action-pane.md`               | 操作ペインとモックのコントロールボタンを作成する。                                                                                                                                                                                                   |
| G24  | done | G4, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G17, G18, G19, G20, G21, G22                                                                  | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-24-sheet-persistence.md`               | 自動保存と保存済み項目の自動復元を扱う。                                                                                                                                                                                                             |
| G25  | done | G4, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G17, G18, G19, G20, G21, G22, G23                                                             | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-25-sheet-error-summary.md`             | エラーの集約表示を扱う。現在の生き様では通常使用不可の専用アイテムカテゴリのwarningは既存の局所フィードバックに留める。                                                                                                                              |
| G26  | done | G4, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G17, G18, G19, G20, G21, G22, G23                                                             | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-26-sheet-json-export.md`               | JSON出力を扱う。                                                                                                                                                                                                                                     |
| G27  | done | G5, G24, G25, G26                                                                                                                               | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-27-sheet-json-import.md`               | JSON入力を扱う。                                                                                                                                                                                                                                     |
| G28  | done | G5, G22, G23, G25, G26                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-28-sheet-ccfolia.md`                   | CCFOLIA出力を扱う。                                                                                                                                                                                                                                  |
| G29  | done | G5, G22, G23, G24, G25                                                                                                                          | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-29-sheet-reset.md`                     | 全クリアを扱う。                                                                                                                                                                                                                                     |
| G30  | done | G5, G23, G24, G25, G26, G27, G28, G29                                                                                                           | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-30-sheet-help.md`                      | ヘルプを扱う。                                                                                                                                                                                                                                       |
| G31  | done | G0, G1, G2, G3, G4, G5, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G16, G17, G18, G19, G20, G21, G22, G23, G24, G25, G26, G27, G28, G29, G30 | `docs/issue/milestone-01/done/cross-phase/ex-02-web-character-sheet/ex-02-31-sheet-integration.md`               | 最終リファクタ、全canonical VRT baselineのローカル専用化・再生成、限定した最終Tech ReviewとUI Reviewを行った。                                                                                                                                       |
...
- JSON入力はG26の現行トップレベル形式をG24のshared restore adapterで復元し、確認後だけフォームと端末内保存を置換する。画像は`imageBase64String`から独立して扱い、`null` / property欠落は削除、非null値は`String`変換後のWebP base64検証とする。不正画像・画像永続化失敗でもフォーム復元を巻き戻さない。
- JSON fileのread / parse中はroot operationで排他し、初期画像復元中も入力を開始しない。確認成功とJSON起点の画像エラーはいずれも、desktopまたはresponsive menuのインポート操作元へfocusを戻す。
- JSON importの確認・構造エラー・画像エラーdialogは、desktop / tablet / mobileのcanonical VRT baselineを追加済みである。後続Gateはこれらのbaselineをユーザー明示承認なしに更新しない。

### G28

- CCFOLIAコピーはtitleなしの確認dialogを経由し、`キャンセル`はmuted outline、`コピー`はdefault solidとする。clipboardへの書込み成功・失敗はそれぞれtitleなしの通知dialogで示し、キャンセル、Escape、確定、通知確認後は操作元へfocusを戻す。
- CCFOLIA JSONは現在のフォーム値と派生値から生成し、PC名、行動値、体力、精神力、縁、覚悟にした縁をコマのname、initiative、statusへ渡す。Clipboard APIはbrowser adapterへ隔離し、失敗はroot operationを解除して通知する。
- CCFOLIA確認・成功通知・失敗通知のdesktop / tablet / mobile canonical VRT baseline 9枚は、ユーザー明示承認によりGit管理へ追加済みである。後続Gateはこれらを更新しない。

### G29

- 初期化はtitleなしの確認dialogを経由し、本文の`\n`を可視改行として表示する。`キャンセル`はmuted outline、`初期化`はdanger solidとする。desktopでは押下button、responsive action menuでは常設menu triggerへ、キャンセル、Escape、確定、reset起因の失敗feedback後にfocusを戻す。
- localStorageのフォーム削除に失敗した場合は画像削除・RHF resetを開始しない。画像削除が失敗した場合は直前のフォーム値をlocalStorageへ補償保存し、フォーム・画像のUI stateを維持して失敗feedbackを表示する。両保存削除が成功した後だけ、RHFの全初期値と画像表示を初期化する。
- `reset-confirm`のdesktop / tablet / mobile canonical VRT baselineは、ユーザー明示承認によりGit管理へ追加済みである。後続Gateはこれらを更新しない。

### G30

- ヘルプdialogは、desktopの`ヘルプ`buttonとtablet / mobileの`?` buttonから同じdialogを開く。visible headingは`ヘルプ`とし、ユーザー承認済み本文を表示する。action footerは置かず、Header内の可視`閉じる`操作を初期focusとする。
- dialog外枠は`CharacterSheetButton`の`default`と同じ青緑アクセント（`--color-link`）を使う。headerを固定し、本文領域だけを縦scrollする。Escapeまたは`閉じる`操作で閉じ、実際に押下したdesktop / responsive triggerへfocusを戻す。
- Help dialogの先頭・中間・最下部をdesktop / tablet / mobileで確認済みであり、local canonical snapshot 9枚はGit管理外で保持する。後続Gateは、G31で定めるbaselineのlocal-only化・再生成以外でこれらを更新しない。

### G31

- Character-sheetのE2Eは、実ブラウザでしか保証できないJSON入出力、CCFOLIA、responsive menu、Pagefind除外だけを最終smokeとして残す。局所state・算出・validationはNode / Component / hook testへ置く。Pagefindの事前確認はPlaywright設定の`baseURL`から解決し、VRTの4321番とE2Eの4322番を混同しない。
- ゲームドメイン用語は`dictionary`で用途別に整理し、FormValueをPresenter / sectionへ渡すpropsとcallbackは、実際のprops境界で参照安定化する。
- `canonical-snapshots/visual/**`はGit管理しないlocal-only artifactとする。Pagefindを含むVRT fixtureで全358 targetを再生成し、更新なしの全件比較も通過した。全体的なpixel ratio許容値は設けない。
- errorなしのerror dialogは通常strong borderとする。ドラッグの初期・追加行の所持セット数は`1`とし、スキル候補dialogは最大Lvとコストの間に折り返さないタイミング列を表示する。候補行を選択可能に見せるdesign検討はTODOへ残す。
