...
- `GitHub Issue #113: ex-02-web-character-sheet`
...
| ---- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| G0   | done | なし                                                                                                                                            | `GitHub Issue #80: ex-02-0-sheet-page-header`                | Astro pageとページ固有のサイトメニュー表示を作成する。HeaderとFooterは再設計しない。                                                                                                                                                                 |
| G1   | done | G0                                                                                                                                              | `GitHub Issue #82: ex-02-1-sheet-runtime`                    | React Islandなどの実行基盤を整備する。                                                                                                                                                                                                               |
| G2   | done | G0, G1                                                                                                                                          | `GitHub Issue #93: ex-02-2-sheet-layout`                     | desktopでは`80rem`以上で等分2列、tablet/mobileでは一列の基本レイアウトを提供する。                                                                                                                                                                   |
| G3   | done | G2                                                                                                                                              | `GitHub Issue #104: ex-02-3-sheet-section-frame`             | 編集セクションの共通枠と開閉操作を作成する。                                                                                                                                                                                                         |
| G4   | done | G1, G2, G3                                                                                                                                      | `GitHub Issue #107: ex-02-4-sheet-profile`                   | 基本情報、キャラクター設定、信用を扱う。                                                                                                                                                                                                             |
| G5   | done | G1, G2, G3                                                                                                                                      | `GitHub Issue #108: ex-02-5-sheet-dialogs`                   | ダイアログの共通基盤を整備する。                                                                                                                                                                                                                     |
| G6   | done | G4, G5                                                                                                                                          | `GitHub Issue #109: ex-02-6-sheet-image`                     | 承認済みdraftのprofile / setting / image / credit配置を保ち、キャラクター画像を扱う。                                                                                                                                                                |
| G7   | done | G1, G2, G3                                                                                                                                      | `GitHub Issue #110: ex-02-7-sheet-build`                     | 流儀、生き様、能力値、経験点を扱う。                                                                                                                                                                                                                 |
| G8   | done | G7                                                                                                                                              | `GitHub Issue #111: ex-02-8-sheet-secondary`                 | 副能力値を扱う。                                                                                                                                                                                                                                     |
| G9   | done | G7, G8                                                                                                                                          | `GitHub Issue #112: ex-02-9-sheet-bonds`                     | 縁と覚悟を扱う。                                                                                                                                                                                                                                     |
| G10  | done | G7                                                                                                                                              | `GitHub Issue #83: ex-02-10-sheet-attack-reaction`           | 攻撃とリアクションを扱う。                                                                                                                                                                                                                           |
| G11  | done | G7                                                                                                                                              | `GitHub Issue #84: ex-02-11-sheet-noncombat`                 | 非戦闘技能を扱う。                                                                                                                                                                                                                                   |
| G12  | done | G7                                                                                                                                              | `GitHub Issue #85: ex-02-12-sheet-primary-skills`            | プライマリ流儀のスキルを扱う。                                                                                                                                                                                                                       |
| G13  | done | G7                                                                                                                                              | `GitHub Issue #86: ex-02-13-sheet-ikizama-skills`            | 生き様のスキルを扱う。                                                                                                                                                                                                                               |
| G14  | done | G7, G12                                                                                                                                         | `GitHub Issue #87: ex-02-14-sheet-common-skills`             | 共通スキルを扱う。                                                                                                                                                                                                                                   |
| G15  | done | G7, G12                                                                                                                                         | `GitHub Issue #88: ex-02-15-sheet-other-ryugi-skills`        | その他流儀のスキルを扱う。                                                                                                                                                                                                                           |
| G16  | done | G7, G12, G13, G14, G15                                                                                                                          | `GitHub Issue #89: ex-02-16-sheet-experience-consistency`    | 消費経験点の算出整合性を確認する。                                                                                                                                                                                                                   |
| G17  | done | G4, G7                                                                                                                                          | `GitHub Issue #90: ex-02-17-sheet-weapons-armor`             | 武器と防具を扱う。                                                                                                                                                                                                                                   |
| G18  | done | G4                                                                                                                                              | `GitHub Issue #91: ex-02-18-sheet-omamori`                   | お守りの個別行の選択・追加・削除・並べ替え・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                               |
| G19  | done | G4                                                                                                                                              | `GitHub Issue #92: ex-02-19-sheet-cybernetics`               | サイバネの個別行の選択・行操作・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                                           |
| G20  | done | G4                                                                                                                                              | `GitHub Issue #94: ex-02-20-sheet-nanomachines`              | ナノマシンの固定個別行の選択・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                                             |
| G21  | done | G4                                                                                                                                              | `GitHub Issue #95: ex-02-21-sheet-drugs`                     | ドラッグの個別行の選択・追加・削除・並べ替え・候補dialogを実装する。生き様連動とカテゴリ操作は扱わない。                                                                                                                                             |
| G22  | done | G4, G7, G17, G18, G19, G20, G21                                                                                                                 | `GitHub Issue #96: ex-02-22-sheet-special-items-integration` | 消費信用を一元算出し、生き様別の既定カテゴリ表示、未選択時のカテゴリ非表示、カテゴリ単位の追加・削除、生き様変更時の入れ替え、通常選択不可の保持アイテム警告、および選択中ナノマシンの発動精神力最大値を最大体力へ反映する生き様との接続を実装する。 |
| G23  | done | G2, G3, G5                                                                                                                                      | `GitHub Issue #97: ex-02-23-sheet-action-pane`               | 操作ペインとモックのコントロールボタンを作成する。                                                                                                                                                                                                   |
| G24  | done | G4, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G17, G18, G19, G20, G21, G22                                                                  | `GitHub Issue #98: ex-02-24-sheet-persistence`               | 自動保存と保存済み項目の自動復元を扱う。                                                                                                                                                                                                             |
| G25  | done | G4, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G17, G18, G19, G20, G21, G22, G23                                                             | `GitHub Issue #99: ex-02-25-sheet-error-summary`             | エラーの集約表示を扱う。現在の生き様では通常使用不可の専用アイテムカテゴリのwarningは既存の局所フィードバックに留める。                                                                                                                              |
| G26  | done | G4, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G17, G18, G19, G20, G21, G22, G23                                                             | `GitHub Issue #100: ex-02-26-sheet-json-export`              | JSON出力を扱う。                                                                                                                                                                                                                                     |
| G27  | done | G5, G24, G25, G26                                                                                                                               | `GitHub Issue #101: ex-02-27-sheet-json-import`              | JSON入力を扱う。                                                                                                                                                                                                                                     |
| G28  | done | G5, G22, G23, G25, G26                                                                                                                          | `GitHub Issue #102: ex-02-28-sheet-ccfolia`                  | CCFOLIA出力を扱う。                                                                                                                                                                                                                                  |
| G29  | done | G5, G22, G23, G24, G25                                                                                                                          | `GitHub Issue #103: ex-02-29-sheet-reset`                    | 全クリアを扱う。                                                                                                                                                                                                                                     |
| G30  | done | G5, G23, G24, G25, G26, G27, G28, G29                                                                                                           | `GitHub Issue #105: ex-02-30-sheet-help`                     | ヘルプを扱う。                                                                                                                                                                                                                                       |
| G31  | done | G0, G1, G2, G3, G4, G5, G6, G7, G8, G9, G10, G11, G12, G13, G14, G15, G16, G17, G18, G19, G20, G21, G22, G23, G24, G25, G26, G27, G28, G29, G30 | `GitHub Issue #106: ex-02-31-sheet-integration`              | 最終リファクタ、全canonical VRT baselineのローカル専用化・再生成、限定した最終Tech ReviewとUI Reviewを行った。                                                                                                                                       |
