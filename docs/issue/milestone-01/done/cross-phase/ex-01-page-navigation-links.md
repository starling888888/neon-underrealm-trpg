...
`docs/issue/milestone-01/plan.md` の `ex-01-page-navigation-links` は、ページ下部に前ページ・次ページへのナビゲーションリンクを追加するtaskである。
...
- [x] planの「完成画面のスクリーンショットを取得し、design正本を更新する」は、Visual Reviewとユーザー承認を経て確認する。承認待ちの場合は未チェックのまま残す。
