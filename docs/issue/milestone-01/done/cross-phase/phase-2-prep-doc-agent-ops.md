...
このタスクでは、`AGENTS.md`、`docs/requirements.md`、`docs/issue/milestone-01/plan.md`、`docs/TODO.md`、`docs/agent-failure-log.md`、`.agents/skills/*`、`.github` 配下のテンプレートなど、agentが頻繁に参照するファイルと運用入口を整理する。
...
- `docs/issue/milestone-01/plan.md`、`docs/TODO.md`、`docs/agent-failure-log.md` に完了済み情報が残り続けると、agentが毎回読む情報量が増える
...
- `docs/issue/milestone-01/plan.md`
- `docs/issue/milestone-01/plan.md` または同等の完了履歴ファイル
- `docs/TODO.md`
- `docs/TODO-done.md` または同等の完了履歴ファイル
- `docs/agent-failure-log.md`
- `docs/agent-failure-log-done.md` または同等の完了履歴ファイル
- `docs/issue/`
- `docs/issue/milestone-01/done/phase-0/`
- `docs/issue/milestone-01/done/phase-1/`
- `docs/issue/milestone-01/done/phase-2/`
- `docs/issue/milestone-01/done/cross-phase/`
...
- `docs/requirements/*`
- `docs/issue/milestone-01/plan.md`
- `docs/issue/milestone-01/done/phase-2/12-mobile-menu.md`
- `docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md`
...
- `docs/issue/milestone-01/plan.md` の完了チェック状態を勝手に変更しない
- 完了条件・チェックポイントの未チェック項目を、移動のために完了扱いへ変更しない
- 未完了issueを `docs/issue/milestone-01/done/` へ移動しない
...
- [x] `docs/issue/milestone-01/plan.md`、`docs/TODO.md`、`docs/agent-failure-log.md` を未実行・未対応中心にする方針が定義されている
...
- [x] `docs/issue/milestone-01/done/phase-N/` と `docs/issue/milestone-01/done/cross-phase/` の使い分けが明記されている
...
- [x] 現在すべての完了条件・チェックポイントがチェック済みの完了済みissueが、定義されたルールに従って `docs/issue/milestone-01/done/phase-X/` または `docs/issue/milestone-01/done/cross-phase/` へ移動されている
- [x] `phase-2-prep-doc-agent-ops` は、完了後に `docs/issue/milestone-01/done/cross-phase/` へ移動する対象として扱われている
...
- [x] `docs/TODO.md` の旧plan ID参照が、現行 `docs/issue/milestone-01/plan.md` のタスクIDへ修正されている
...
- [x] `docs/content-writing-guide.md` のページ配置・ルーティング表現が、現行 `docs/issue/milestone-01/plan.md` Phase 3を参照する形になっている
- [x] `docs/requirements.md` および分割後の `docs/requirements/*` の技術スタック記述が、採用済み / 後続予定の区別を持っている
- [x] `docs/requirements/*` と `docs/issue/milestone-01/plan.md` から、Footerおよび `18-2-home-page` の必須クレジット枠扱いが外れている
- [x] `docs/issue/milestone-01/done/phase-2/12-mobile-menu.md` の旧plan ID参照に、過去記録であること、現在は旧IDであることが注記されている
- [x] `docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md` のdeploy確認記録が、merge後確認済みとして読み取れる
...
- [x] `docs/TODO.md` の項目が現行 `docs/issue/milestone-01/plan.md` と矛盾していない
- [x] `docs/design/` の正本と矛盾する記述を増やしていない
- [x] `docs/issue/milestone-01/plan.md` の完了チェック状態を変更していない
...
- [x] `docs/issue/milestone-01/done/phase-N/` と `docs/issue/milestone-01/done/cross-phase/` の分類が曖昧でない
...
- `docs/issue/milestone-01/plan.md`、`docs/TODO.md`、`docs/agent-failure-log.md` を未実行・未対応中心にする方針でよいか
...
- 完了済みissueの移動先を `docs/issue/milestone-01/done/phase-N/` および `docs/issue/milestone-01/done/cross-phase/` とする方針でよいか
- `docs/issue/milestone-01/done/phase-N/` と `docs/issue/milestone-01/done/cross-phase/` の分類ルールが妥当か
- phase判定の粒度が妥当か
...
- `docs/issue/milestone-01/done/phase-2/17-github-actions-deploy-basic.md` のmerge後確認済み表現が事実関係として問題ないか
- `docs/issue/milestone-01/plan.md` の完了チェックを変更しない方針でよいか
- 完了済みissueの判定を「すべての完了条件・チェックポイントがチェック済み」とする方針でよいか
- `docs/issue/milestone-01/done/phase-N/` へ移動する対象issueのphase範囲を、Phase 0からPhase 1完了分まで含めるか、Phase 2開始前に必要な範囲へ限定するか
- plan番号に属さない横断整備issueを `docs/issue/milestone-01/done/cross-phase/` へ移動する方針でよいか

## 備考

このタスクは `docs/issue/milestone-01/plan.md` の既存番号に直接存在しない、Phase 1完了後 / Phase 2開始前の補助ドキュメント整合・開発品質向上・参照構造整理タスクとして扱う。

branch名は、`docs/issue/milestone-01/plan.md` の既存番号に直接紐づかないPhase 2準備タスクとして、`phase-2-prep-doc-agent-ops` とする。
...
`.tmp/phase1-doc-consistency-report.md` のうち、`docs/issue/milestone-01/done/phase-2/16-layout-screenshot-design-refresh.md` への追加整理は、ユーザー追記で「対応しない」とされたため、このタスクでは扱わない。
...
- `docs/issue/milestone-01/done/phase-N/`
  - `docs/issue/milestone-01/plan.md` のPhase Nに属する完了済みissue
  - plan番号またはphase内作業と直接対応するもの
- `docs/issue/milestone-01/done/cross-phase/`
  - 特定phaseに閉じない完了済みissue
  - phase境界の整理、AGENTS / SKILL / repo運用、docs構造整理など

`phase-2-prep-doc-agent-ops` は `docs/issue/milestone-01/plan.md` のPhase 2実装タスクではなく、Phase 2以降へ進むための横断整備タスクであるため、完了後は以下へ移動する。

```text
docs/issue/milestone-01/done/cross-phase/phase-2-prep-doc-agent-ops.md
```
...
- requirements索引化方針
- active / done分離方針
- `docs/issue/milestone-01/done/phase-N/` と `docs/issue/milestone-01/done/cross-phase/` の分類方針
...
- 要件内容の大幅な意味変更
- 実装方針の追加
- `docs/issue/milestone-01/plan.md` のチェック更新
- codeやscriptsの移動
...
- `docs/issue/milestone-01/plan.md` は未完了・進行対象中心にする方針
...
- issue完了時に `docs/issue/milestone-01/done/phase-N/` または `docs/issue/milestone-01/done/cross-phase/` へ移動する方針
- phase判定
- cross-phase判定
- 移動対象外ファイル
- 移動条件
...
- `docs/issue/milestone-01/plan.md` の完了チェックを勝手に変更しない既存方針との整合
...
すべての完了条件・チェックポイントがチェック済みの完了済みissueを、issueの性質に応じて `docs/issue/milestone-01/done/phase-N/` または `docs/issue/milestone-01/done/cross-phase/` へ移動する。
...
- phase判定
- cross-phase判定
- `docs/issue/milestone-01/done/phase-N/` への移動
- `docs/issue/milestone-01/done/cross-phase/` への移動
- 移動したissueへの既存内部リンク更新
...
- `docs/issue/milestone-01/plan.md` の完了チェック変更
- issue本文の大幅編集
...
- `docs/TODO.md`, `docs/issue/milestone-01/plan.md`, `docs/requirements.md`, `docs/out-of-scope.md`, `docs/agent-failure-log.md`, and relevant existing issue files exist locally.
...
- `.agents/skills/failure-log-audit/SKILL.md`
- `docs/requirements/`
- `docs/issue/milestone-01/plan.md`, `docs/TODO-done.md`, and `docs/agent-failure-log-done.md`
- `docs/issue/milestone-01/done/`
