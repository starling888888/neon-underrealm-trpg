...
このissue内のplan ID / issue path参照は、実装当時の作業記録として保持する。現在このissueは完了済み履歴として `docs/issue/done/phase-2/12-mobile-menu.md` に退避済みである。
...
* 必要に応じて `docs/issue/done/phase-2/12-mobile-menu.md`
...
* issue file `docs/issue/done/phase-2/12-mobile-menu.md` をローカルで確認済み
