...
| G16  | in progress | G7, G12, G13, G14, G15                                                                                                                          | `docs/issue/ex-02-16-sheet-experience-consistency.md`                            | 消費経験点の算出整合性を確認する。                                                    |
...
| G20  | planned     | G4, G7, G8                                                                                                                                      | `docs/issue/ex-02-20-sheet-nanomachines.md`                                      | ナノマシンを扱う。                                                                    |
