...
| ---- | ----------- | -------- | ------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| G1   | in progress | なし     | `docs/issue/milestone-02-phase-02-gm-section-g01-gm-guide.md`       | GMガイドと初回公開用メニュー構造を完成させる。                         |
...
| G6   | planned     | G1〜G5   | `docs/issue/milestone-02-phase-02-gm-section-g06-first-scenario.md` | サンプルシナリオ1本とGMセクション初回公開を完成させる。                |
