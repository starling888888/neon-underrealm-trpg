...
- [x] 長い説明、複数行の共通スキルボーナス、長いスキル本文で横overflowや切り詰めがない
...
| overflow / scroll     | OK   | desktop / mobileのVisual Testでdocument横overflowなし                                          | 不要                     |
...
- [ ] `最大LV`の配置変更をdesign画像にも反映する場合は、design fix modeでcanonical designを更新する
