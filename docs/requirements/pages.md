...
各生き様の説明、生き様データ、生き様ボーナススキル、生き様スキル一覧、専用アイテムへのリンクを表示する。
...
生き様ボーナススキル、生き様スキル一覧、専用アイテムは、Excelから変換されたデータを参照して表示する。

生き様ボーナススキルは `skills.bonus` の先頭要素を `SkillCard` で表示する。生き様スキル一覧は
