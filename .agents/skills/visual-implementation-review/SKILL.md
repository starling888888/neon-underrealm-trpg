...
9. Update or append `## ビジュアルレビュー N` in the current issue file.
...
Stop for human judgment when a change would affect information architecture, navigation structure, page text, URLs, global breakpoints, global design tokens, large component structure, or any out-of-scope file.
